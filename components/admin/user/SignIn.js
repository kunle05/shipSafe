            ...
            <Form method="POST" onSubmit={handleSubmit}>
              <fieldset disabled={loading} aria-busy={loading}>
                ...
                <div className="d-flex justify-content-between">
                  <a className="safelink" onClick={() => setMode({ login: false, password: true })}>
                    Reset Password
                  </a>
              ...
              {data?.requestReset.message && (
                <Row className="notify">
                  ...
                  <div>
                    <p>
                      <small>
                        Check your email for password reset instructions or follow the{' '}
                        <a style={{ textDecoration: 'underline' }} href={data?.requestReset.message}>
                          reset link
                        </a>
                      </small>
                    </p>
